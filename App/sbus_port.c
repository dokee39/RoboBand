...
void sbus_frame_parse(remoter_t *remoter, uint8_t *buf)
{
    ...
    {
        remoter->joy.left_hori = deadline(remoter->rc.ch[3] - RC_CH_VALUE_OFFSET, -REMOTER_DEADLINE, REMOTER_DEADLINE);
        remoter->joy.left_vert = 1686 - remoter->rc.ch[2];
        remoter->joy.right_hori = deadline(remoter->rc.ch[0] - RC_CH_VALUE_OFFSET, -REMOTER_DEADLINE, REMOTER_DEADLINE);
        remoter->joy.right_vert = deadline(remoter->rc.ch[1] - RC_CH_VALUE_OFFSET, -REMOTER_DEADLINE, REMOTER_DEADLINE);
